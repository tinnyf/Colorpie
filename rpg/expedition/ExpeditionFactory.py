                ...
                [
                    ...
                    (
                        EndPage(player_handler,
                                ...
                                rewards={"relics": 60}, buttons={"Split the Loot": (LootButton, 3,  discord.ButtonStyle.primary)}, step_cost=5
                                )
                    ),
                ]
        }

    def get_expedition(self, players, host, expedition=None):
        if expedition is None:
            expedition = random.choices(self.expeditions)
        expedition = Expedition(expedition, self.expeditions[expedition], players, host)
        return expedition
